...
import com.example.kitepkana.databinding.ItemReadingBinding
import com.example.kitepkana.domain.model.Books
import com.example.kitepkana.presentation.utils.loadImage

class ReadingAdapter(val onClick: (position: Int) -> Unit) :
    ListAdapter<com.example.kitepkana.domain.model.Books, ReadingAdapter.FavoritesViewHolder>(DiffUtilNoteItemCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoritesViewHolder {
        return FavoritesViewHolder(
            ItemReadingBinding.inflate(
    ...
    inner class FavoritesViewHolder(private val binding: ItemReadingBinding) :
